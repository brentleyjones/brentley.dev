...
[bazel-7-0]: https://blog.bazel.build/2023/11/29/bazel-7.0.html
...
- <a id="experimental_remote_cache_compression"></a><a id="remote_cache_compression"></a>`--experimental_remote_cache_compression` to `--remote_cache_compression` ([0cdd409](https://github.com/bazelbuild/bazel/commit/0cdd40972ba5253b4b4f0de80f080a911dc8c99b))
...
- <a id="incompatible_remote_use_new_exit_code_for_lost_inputs"></a>`--incompatible_remote_use_new_exit_code_for_lost_inputs=true` ([c77790f](https://github.com/bazelbuild/bazel/commit/c77790f55e90a4f66d3c439b583ad7fe0b9a34fd))
...
- <a id="experimental_collect_local_action_metrics"></a>`--experimental_collect_local_action_metrics` ([549254e](https://github.com/bazelbuild/bazel/commit/549254e48c6976a3a16ca8c22122a423c8c6d7a0))
...
- <a id="distinct_host_configuration"></a>`--distinct_host_configuration` ([9c01a5a](https://github.com/bazelbuild/bazel/commit/9c01a5adb09f30feadc8d84c7ee19a3944a42bdb))
...
- <a id="experimental_prioritize_local_actions"></a>`--experimental_prioritize_local_actions` ([e45b8d4](https://github.com/bazelbuild/bazel/commit/e45b8d40ac5cf380c713bfdb860ab011c602714c))
...
- <a id="incompatible_disable_third_party_license_checking"></a>`--incompatible_disable_third_party_license_checking` ([ae40562](https://github.com/bazelbuild/bazel/commit/ae405626c63cbea9f98b1a7dd08238b0200d780b))
...
- {% version "6.3.0" %} `--experimental_remote_cache_eviction_retries` is now disabled if `--invocation_id` is set. ([d9b94cb](https://github.com/bazelbuild/bazel/commit/d9b94cbc86a5eb063974c159d404cce68ee56409))
...
- {% version "6.2.0" %} Fixed an issue where WORKSPACE and WORKSPACE-loaded .bzl files couldn't see the Bzlmod root module's mappings when Bzlmod is enabled. ([dfdf63a](https://github.com/bazelbuild/bazel/commit/dfdf63a398ef3909364d31d00d1860bf42d6151f))
...
- {% version "6.1.0" %} `xcrun` is now used to invoke `install_name_tool`. ([8ec8743](https://github.com/bazelbuild/bazel/commit/8ec874348226995c4101b2173a465ddc65cab591))
- {% version "6.1.0" %} Dropped support for macOS versions prior to 10.13. ([43dadb2](https://github.com/bazelbuild/bazel/commit/43dadb275b3f9690242bf2d94a0757c721d231a9))
- {% version "6.2.0" %} Patched `zlib` to fix compatibility with latest Xcode. ([1f2b3ed](https://github.com/bazelbuild/bazel/commit/1f2b3ed4ac717b814d02a0d125f160ddabe78003))
- {% version "6.3.0" %} Bumped `default_macos_sdk_version` to `10.11`. ([86ef4f4](https://github.com/bazelbuild/bazel/commit/86ef4f4cc2b8f7fd58101eb49c266be63f6e923c))
- {% version "6.4.0" %} Added initial visionOS support. ([c113e62](https://github.com/bazelbuild/bazel/commit/c113e6261aa0c5d593ff6091200463c01fd101cd))
- {% version "6.4.0" %} The `xcode_autoconf` repository rule will now re-run when the `DEVELOPER_DIR` or `XCODE_VERSION` environment variable changes. ([19979e6](https://github.com/bazelbuild/bazel/commit/19979e619ccbb8257a6d696553e1b00fafccb504))
- {% version "6.4.0" %} Removed the `-s` flag from `libtool` invocation. ([ae7cfa5](https://github.com/bazelbuild/bazel/commit/ae7cfa59461b2c694226be689662d387e9c38427))
...
- {% version "6.3.0" %} `--local_termination_grace_seconds` is now used when testing sandbox availability. ([d0e19ae](https://github.com/bazelbuild/bazel/commit/d0e19ae1943ce50f91bb64f1aca132632245f3e8))
...
- {% version "6.1.0" %} The `archive_param_file` feature is now enabled by default for Windows. ([bb0b886](https://github.com/bazelbuild/bazel/commit/bb0b886271d45209e3bef476da37811b9dd2afe5))
- {% version "6.1.0" %} Fixed `--nozip_undeclared_test_outputs` on Windows. ([cd10d50](https://github.com/bazelbuild/bazel/commit/cd10d508e20a4964586b46f7edea8a6dc900157c))
- {% version "6.2.0" %} C++ deps pruning is now enabled on Windows when PARSE_SHOWINCLUDES is available. ([788801a](https://github.com/bazelbuild/bazel/commit/788801a8fd30985a1831de805172d257c6f63691))
- {% version "6.3.0" %} Fixed VS 2022 autodetection. ([cd33d14](https://github.com/bazelbuild/bazel/commit/cd33d148ad31a23ba87aa59c745e3ce826dcd967))
- {% version "6.4.0" %} Compilation actions using the auto-configured MSVC toolchain are forced to emit error messages in English if the English language pack for Visual Studio is installed. ([0f10359](https://github.com/bazelbuild/bazel/commit/0f103598bba32439355c94b2c226fb60625c94dd))
- {% version "6.4.0" %} Fixed Bash runfiles failure when the output base contains uppercase letters. ([ea4ab7d](https://github.com/bazelbuild/bazel/commit/ea4ab7d8e696f48253fd172fcfbd37661e4710d5))
...
- {% version "6.1.0" %} Fixed `runfiles_current_repository` with RBE. ([497b7e4](https://github.com/bazelbuild/bazel/commit/497b7e403d6e5523bd1310bd1fe83c4ce1a6b1ec))
- {% version "6.1.0" %} Fix root symlink edge case in runfiles library. ([dd24a00](https://github.com/bazelbuild/bazel/commit/dd24a0022a0ff959598da2c9bc097d27083be1a0))
...
- {% version "6.1.0" %} Added support for `.pyd` extensions. ([073f54b](https://github.com/bazelbuild/bazel/commit/073f54b9a7c46afd2c28b4a99a235bdd6b63bb5f))
- {% version "6.1.0" %} Added support for `.wasm` extensions. ([de062a6](https://github.com/bazelbuild/bazel/commit/de062a6750fdea75361e42f8d198c09bf6825d76), [4b6f014](https://github.com/bazelbuild/bazel/commit/4b6f0141b8df49f4911af725f766e9dd8128a000))
- {% version "6.1.0" %} Added the sanitizer features to `unix_cc_toolchain_config`. ([abae5ca](https://github.com/bazelbuild/bazel/commit/abae5ca3e8142f93cf0c2597e3410ed955c4dd59))
- {% version "6.1.0" %} The exec transition is now applied to `lcov_merger` in `sh_test` and `cc_test`. ([37953c5](https://github.com/bazelbuild/bazel/commit/37953c56ea77c7aa7bea677f3481557fdb2c2a15))
- {% version "6.1.0" %} The `cc_shared_library.roots` attribute was renamed to `deps`. ([68aad18](https://github.com/bazelbuild/bazel/commit/68aad18cfc01400bf6c3f447b6cd7d21dcc8f01f))
- {% version "6.1.0" %} `libtool` is no longer hardcoded when using the unix cc toolchain. ([3c47b47](https://github.com/bazelbuild/bazel/commit/3c47b4716e6eca2b8ab06253915ef8d1bdd28038))
- {% version "6.1.0" %} Removed the `-O1` flag from sanitizer feature flags. ([e132653](https://github.com/bazelbuild/bazel/commit/e132653ead5e50f4226dbff7776466fef1918f49))
- {% version "6.1.0" %} Removed the `static_deps` attribute from `cc_shared_library`. ([9815b76](https://github.com/bazelbuild/bazel/commit/9815b76121d4e36bdaae110de7e68131916478ca))
- {% version "6.2.0" %} Exposed `cc_proto_aspect` as a toplevel symbol. ([2aa06cf](https://github.com/bazelbuild/bazel/commit/2aa06cf227fe349195191107286167035f0c5431))
- {% version "6.3.0" %} Added the `force_no_whole_archive` feature, which force disables `--whole-archive`. ([661ebef](https://github.com/bazelbuild/bazel/commit/661ebef465b08697a82fc3ee4c9fd540d953dc84))
- {% version "6.3.0" %} Added the `additional_compiler_inputs` attribute to `cc_library`. ([ade32e6](https://github.com/bazelbuild/bazel/commit/ade32e68dc7aa23b5038cd44a4b86cb491818139))
- {% version "6.3.0" %} Added the `CcSharedLibraryHintInfo` provider. ([dbb09c9](https://github.com/bazelbuild/bazel/commit/dbb09c9ea84cc6099ad7a30fa8206130d025f7ad))
- {% version "6.3.0" %} File extensions are case sensitive again. ([e4990f8](https://github.com/bazelbuild/bazel/commit/e4990f8a20e44f7a7875f614e9fc2fe24b051fd9))
- {% version "6.3.0" %} Unused targets listed in `cc_shared_library.dynamic_deps` are now linked. ([ba5c740](https://github.com/bazelbuild/bazel/commit/ba5c74038ed3ae633a9bf8346c88b01e1931992e))
- {% version "6.3.0" %} `cc_binary` targets with `dynamic_deps` attributes no longer link indirect `dynamic_deps` on Unix. ([95ae4db](https://github.com/bazelbuild/bazel/commit/95ae4dbfe34fee7b033c4b7918e1afdc1cee017a))
- {% version "6.3.0" %} Added the `exclude_bazel_rpaths_in_transitive_libs` and `link_indirect_dynamic_deps_in_binary` features. ([95ae4db](https://github.com/bazelbuild/bazel/commit/95ae4dbfe34fee7b033c4b7918e1afdc1cee017a))
- {% version "6.3.0" %} Removed `cc_shared_library_permissions`. ([adfd4df](https://github.com/bazelbuild/bazel/commit/adfd4dff773161ce5280a80f568b3584a94f277a))
- {% version "6.3.0" %} Removed the `preloaded_deps` attribute from `cc_shared_library`. ([3b7e233](https://github.com/bazelbuild/bazel/commit/3b7e2335d9624b63a2e190fd27b960826bf8f649))
- {% version "6.3.0" %} Fixed the `cc_shared_library` aspect to propagate along all attributes. ([590ee17](https://github.com/bazelbuild/bazel/commit/590ee17c225244efd48793899170bc11f64b65d2))
- {% version "6.3.0" %} Fixed the order of linker inputs in `cc_binary` and `cc_shared_library`. ([a772452](https://github.com/bazelbuild/bazel/commit/a77245215e61187dba763dd619cc60c62fb346bb))
- {% version "6.3.0" %} Fixed rpath for symlinks in `cc_shared_library`. ([044a14c](https://github.com/bazelbuild/bazel/commit/044a14cca2747aeff258fc71eaeb153c08cb34d5))
- {% version "6.3.0" %} Fixed `cc_shared_library` to take into account unused `CcInfo`s. ([b6b9eec](https://github.com/bazelbuild/bazel/commit/b6b9eec8ea44ceca80d345c1b3b81412bbd97a81))
- {% version "6.3.0" %} Fixed `cc_shared_library` to take into account indirect top level deps. ([f9008f6](https://github.com/bazelbuild/bazel/commit/f9008f698467eb85657711c608db16086a9908eb))
- {% version "6.3.0" %} Fixed `exports_filter` in `cc_shared_library`. ([bc33ac2](https://github.com/bazelbuild/bazel/commit/bc33ac2d4f0ce39524ca88833aaf26427a3d7e00))
- {% version "6.4.0" %} Added the `additional_linker_inputs` attribute to `cc_library`. ([0589995](https://github.com/bazelbuild/bazel/commit/05899953a1726328b0ff9d940720e363260ce5c4))
- {% version "6.4.0" %} Debug info context is now collected from the `cc_library.implementation_deps` attribute. ([e55fee2](https://github.com/bazelbuild/bazel/commit/e55fee2938b38605cd3da7fc9c790da71961dd1a))
- {% version "6.4.0" %} Data dependencies are now propagated through the `cc_library.implementation_deps` attribute. ([56e9020](https://github.com/bazelbuild/bazel/commit/56e9020b434e321d51d077428cd5f49bee940ee2))
- {% version "6.4.0" %} `c++14` is now used as the default C++ standard. ([978cd23](https://github.com/bazelbuild/bazel/commit/978cd23e80f202a03e99a87f2089a9a0622b5d5d))
...
- {% version "6.1.0" %} Coverage can now be collected for external targets. ([00e9af1](https://github.com/bazelbuild/bazel/commit/00e9af1985cc0227599516fe7568785ca4334050))
- {% version "6.1.0" %} Fixed coverage collection with the Java 8 runtime. ([c266651](https://github.com/bazelbuild/bazel/commit/c26665102d0d524bb42be8cd205c7b31a22a75c9))
- {% version "6.1.0" %} Fixed `--experimental_java_classpath=bazel`. ([ac504cb](https://github.com/bazelbuild/bazel/commit/ac504cbb463e76b1374d0060534acabbccb408d2))
- {% version "6.2.0" %} Added the `version` attribute to `java_runtime` and `JavaRuntimeInfo`. ([7556e11](https://github.com/bazelbuild/bazel/commit/7556e1107b666d10b660470a571631463c7eb4ec))
- {% version "6.2.0" %} Added `-Xep:IgnoredPureGetter:OFF` to default `javacopts`. ([3b57894](https://github.com/bazelbuild/bazel/commit/3b5789473db34481e4d121d08461c19961bf729b))
- {% version "6.2.0" %} Added `-Xep:LenientFormatStringValidation:OFF` to default `javacopts`. ([33a3b01](https://github.com/bazelbuild/bazel/commit/33a3b01d7ecfcf27102e8cde1253dac987f4a958))
- {% version "6.2.0" %} Added `-Xep:ReturnMissingNullable:OFF` to default `javacopts`. ([e80ca15](https://github.com/bazelbuild/bazel/commit/e80ca154239d189a69323048eba0cd6c31e60da4))
- {% version "6.2.0" %} JVM warnings are now redirected to stderr. ([abea37b](https://github.com/bazelbuild/bazel/commit/abea37b3519172ce8810e765b10aa377ef70de3b))
- {% version "6.3.0" %} `local_java_repository` now sets the `version` attribute of `java_runtime`. ([1c1584b](https://github.com/bazelbuild/bazel/commit/1c1584b4081972c69d7746243f023257387d8121))
- {% version "6.3.0" %} `ijar` now handles dynamic constants. ([69d2991](https://github.com/bazelbuild/bazel/commit/69d299165743613d303f19f47d8b3db4481d58b5))
- {% version "6.4.0" %} Added a toolchain type for the Java bootstrap runtime. ([8715e9a](https://github.com/bazelbuild/bazel/commit/8715e9ae6f5c2fd42607018b3adaad14bf601a1c))
- {% version "6.4.0" %} Optimized classpath pre-processing in `java_stub_template.txt`. ([4e8f0bd](https://github.com/bazelbuild/bazel/commit/4e8f0bdb4eca04844a86e3c7affc8aa85245e75a))
...
- {% version "6.3.0" %} Added the `implementation_deps` attribute to `objc_library`. ([ae7b9c5](https://github.com/bazelbuild/bazel/commit/ae7b9c5a32ce1ce0c102221265db641229870c54))
- {% version "6.4.0" %} Added the `--incompatible_disable_objc_library_transition` flag, which removes `objc_libary`'s custom transition. ([0f34e76](https://github.com/bazelbuild/bazel/commit/0f34e76f45a2d9a6407431ea3a371a9d62814527))
...
- {% version "6.3.0" %} Added the `output_files` attribute to `proto_lang_toolchain`. ([4d14d3f](https://github.com/bazelbuild/bazel/commit/4d14d3f0bb7e49a7ca60540707312982036e086c))
...
- {% version "6.1.0" %} Added host transition to the `lcov_merger` attribute of `py_test`. ([4a6d056](https://github.com/bazelbuild/bazel/commit/4a6d056a8d058ab98a01348fb0c046660ee99a71))
- {% version "6.2.0" %} Fixed runfiles lookup when using a manifest file. ([91584dd](https://github.com/bazelbuild/bazel/commit/91584dd4f189f60b67d1984aeeaf2de8496ea824))
...
- {% version "6.1.0" %} Added the `--incompatible_use_host_features` flag, which causes the `--features` flag to only apply to the target configuration, while the `--host_features` flag only applies to the exec configuration. ([0ef9c7c](https://github.com/bazelbuild/bazel/commit/0ef9c7c2ad097b555f0dc25a5e65d5440a20d7df))
- {% version "6.1.0" %} Added the `package_relative_label` function on the `native` module. ([b859571](https://github.com/bazelbuild/bazel/commit/b859571804f2095caaf018b172b59c90f185fd51))
- {% version "6.1.0" %} The `map_each` callback in `template_dict.add_joined` can now return `None`. ([db68419](https://github.com/bazelbuild/bazel/commit/db684196afd3b1a0a0e7d883674324bd161ae8bf))
- {% version "6.1.0" %} The `map_each` callback in `template_dict.add_joined` can now return a list of strings. ([8783459](https://github.com/bazelbuild/bazel/commit/87834594eff2a312b84832f382dc1f8844b1e8a3))
- {% version "6.2.0" %} Added the `module_name` and `module_version` attributes on the `native` module. ([bcf309b](https://github.com/bazelbuild/bazel/commit/bcf309b88949fe1bbff1776d88fdaa5c3e1d2d37))
- {% version "6.2.0" %} `json.decode` now accepts duplicate keys. ([8548e20](https://github.com/bazelbuild/bazel/commit/8548e202a6871a17f0d097e2cedc9ff8064ef962))
- {% version "6.2.0" %} Multiple matching `select` branches are now allowed if they resolve to the same value. ([d43737f](https://github.com/bazelbuild/bazel/commit/d43737f95d28789bb2d9ef2d7f62320e9a840ab0))
- {% version "6.4.0" %} Added the `--incompatible_merge_fixed_and_default_shell_env` flag, which merges rule supplied and shell provided environment variables. ([d1fdc53](https://github.com/bazelbuild/bazel/commit/d1fdc5303fd3cc22c5091aa4ce7df02eef09d922))
- {% version "6.4.0" %} Optimized empty depsets. ([fa0ff49](https://github.com/bazelbuild/bazel/commit/fa0ff4996a7d3b8cff974e96a604651d6c6e9f9e))
- {% version "6.4.0" %} Optimized single transitive depsets. ([216fce5](https://github.com/bazelbuild/bazel/commit/216fce58b81de2c597a78c16514006a4be4891f5))
- {% version "6.4.0" %} Rule and aspect validation output groups are now merged. ([cd72583](https://github.com/bazelbuild/bazel/commit/cd725834eba3edb53b7a7dd9867363ef1fe00e57))
- {% version "6.4.0" %} When the `repr` function is called on an exported rule the name of the rule is now included in the output. ([002490b](https://github.com/bazelbuild/bazel/commit/002490b9a2376f0b2ea4a37102c5e94fc50a65ba))
...
- {% version "6.1.0" %} `--platforms` is no longer cleared in transitions when no change is made to `--cpu`. ([5b4de12](https://github.com/bazelbuild/bazel/commit/5b4de12b37cb4ba921b6bdfe810bbb47921ab3a6))
...
- {% version "6.2.0" %} `@foo` labels can now be used on the command line as the top-level target. ([24f6fe8](https://github.com/bazelbuild/bazel/commit/24f6fe802ebb68da71e1e071c9e84c89b4aa0772))
- {% version "6.3.0" %} Options specified on the pseudo-command `common` in `.rc` files are now ignored by commands that do not support them as long as they are valid options for any Bazel command. ([44d3953](https://github.com/bazelbuild/bazel/commit/44d395338ab9a27596b0796c14076641f4cb2093))
- {% version "6.3.0" %} Added the `always` pseudo-command which has the semantics of pre-6.3.0 `common` in `.rc` files. ([44d3953](https://github.com/bazelbuild/bazel/commit/44d395338ab9a27596b0796c14076641f4cb2093))
- {% version "6.3.0" %} Credential helpers now apply to repository fetching as well. ([9731e69](https://github.com/bazelbuild/bazel/commit/9731e6906cba63a1eba0c1fb335290d76efabf16))
- {% version "6.3.0" %} Wall-time is now used for credential helper invalidation. ([5f77aba](https://github.com/bazelbuild/bazel/commit/5f77abaca0457d83a78e89ba1549196ce2f4d798))
...
[rolling-releases]: https://bazel.build/versions/7.0.0/release/versioning#rolling-releases
